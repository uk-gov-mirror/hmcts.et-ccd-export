...
FactoryBot.define do
  factory :claim, class: ::EtCcdExport::Test::Json::Node do
    ...
    after(:build) do |claim, evaluator|
      ...
      claim.primary_respondent = build(:respondent, *evaluator.primary_respondent_traits) if claim.primary_respondent.blank? && evaluator.number_of_respondents > 1
      ...
      claim.primary_representative = build(:representative, *evaluator.primary_representative_traits) unless evaluator.primary_representative_traits.nil?
    end
